    ...
    char *css, size_t capacity, char *adapter, size_t adapter_capacity)
{
    ...
    const char *content_shape =
        "body[data-tilefinch-reader-kind]>*:not([data-tilefinch-reader-root])"
        "{display:none!important}"
        "[data-tilefinch-reader-root]{display:block!important;box-sizing:border-box!important;"
        ...
        "font-size:.78rem!important;color:#66594d!important;"
        ...
        "overflow:auto!important;border-collapse:collapse!important}"
        "[data-tilefinch-reader-root] th,[data-tilefinch-reader-root] td{"
        "padding:4px 6px!important;border:1px solid #b8a58f!important}"
        "[data-tilefinch-reader-root] pre{display:block!important;"
        "box-sizing:border-box!important;width:100%!important;max-width:100%!important;"
        "overflow:auto!important;white-space:pre-wrap!important;word-break:break-word!important}"
