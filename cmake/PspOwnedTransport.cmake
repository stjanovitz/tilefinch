...
ExternalProject_Add(tilefinch_psp_curl
    ...
    CMAKE_ARGS
        ...
        "-DCURL_ZSTD=OFF"
        "-DCURL_ZLIB=ON"
        # HTTP_ONLY also compiles curl's WebSocket framing API out. Keep the
        # same protocol footprint explicitly while admitting WS/WSS, which
        # reuse the HTTP/TLS implementation and existing multi worker.
        "-DHTTP_ONLY=OFF"
